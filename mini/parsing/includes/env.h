...
/*   Updated: 2025/06/13 13:18:05 by absaadan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*replace_substring(char *str, char *start, char *end,
						char *replacement);
char				*replace_substring_2(char *original, int start, int end,
						char *replacement);

char				*expand_env_in_string(char *str, t_env *env_list,
						int last_exit_status);
void				expand_env_variables(t_token *tokens, t_env *env_list,
						int last_exit_status);
void				expand_env_variables_improved(t_token *tokens,
...
char				*expand_env_in_string(char *str, t_env *env_list,
						int last_exit_status);
char				*replace_exit_status(char *str, char *dollar, char *pos,
						int exit_code);
char				*replace_env_var(char *str, char *dollar, char *pos,
						t_env *env_list);
